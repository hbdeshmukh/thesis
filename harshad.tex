...
\definecolor{PlotOrange}{HTML}{FC8D59}
\definecolor{PlotGreen}{HTML}{91CF60}
...
\definecolor{gray75}{gray}{0.75}
  ...
  \hypersetup{
     ...
     pdftitle={Efficient Query Scheduling},
     pdfauthor={Harshad Deshmukh},
     pdfkeywords={scheduling, database system, in-memory},
...
\include{system/quickstep}
\include{policy/scheduler}
...
\begin{appendices}
\include{backmatter/appendix-intro}
\end{appendices}
