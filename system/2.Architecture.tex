...
%\begin{figure}
% \centering
%  \includegraphics[height=.45\columnwidth, natwidth=1252bp, natheight=822]{pictures/logical-architecture.png}
%   \caption{The Quickstep logical architecture.}
...
%\begin{table}[t]
%	\centering
%	\begin{tabular}{|p{2.5cm}|p{4.5cm}|} \hline
