...
\begin{figure*}[#7]
%    \flushleft
    \begin{subfigure}[b]{0.19\textheight}
				\includegraphics{#1}
%				\vspace*{-1em}
        \caption{#5}
    \end{subfigure}
...
\input{system/2.Architecture}
\input{system/3.SM}
\input{system/4.Execution}
\input{system/5.Optimization}
\input{system/6.Evaluation}
\input{system/7.Related}
\input{system/8.Conclusions}
